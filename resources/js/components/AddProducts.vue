                ...
                <div class="col">
                    <select class="form-select" aria-label="Default select example" v-model="productId">
                        <option v-for="product in products" :key="product.id" v-bind:value=product.id>{{
                                product.name + ' (Cantidad disponible: ' + product.quantity + ')'
                            }}
                        </option>
                    </select>
                </div>
...
<!--                    //TODO: validar que no pueda introducr el zero-->
                ...
                <div class="col">
                    <button type="button" class="btn btn-primary" v-on:click="addProduct">Agregar</button>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <select id="client" class="form-select" v-model="form.clientId">
            ...
            <div class="row">
                <div class="col">
                    <button type="button" class="btn btn-primary" v-on:click="submitData">Crear Venta</button>
                </div>
            </div>
        </div>
