        ...
        <div class="col">
            ...
            <form action="{{ route('tag.update', $tag) }}" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <input value="{{$tag->name}}" required type="text" class="form-control" id="exampleInputName" aria-describedby="nameHelp" name="nombre">
                </div>

                <button type="submit" class="btn btn-success">Actualizar Tag</button>
